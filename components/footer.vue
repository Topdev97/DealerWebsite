<template>
    <div class="bg-[#F1F2F4]">
        <div class=" py-[96px] px-[80px] max-w-[1480px] mx-auto">
            <div class="flex justify-between">
                <img class="md:w-[200px] h-[30px] xl:w-[300px] xl:h-[35px]" src="../static/logo.png" alt="">
                <ul class="flex justify-start items-center xl:space-x-[40px] 2xl:space-x-[48px] text-[#272A31] text-[16px]">
                    <li>
                        <a href="#">Terms</a>
                    </li>
                    <li>
